...
- PWA support
- **P0 Bug Fix (Apr 2026):** `build_rbac_filter` helper — agents always see ALL own loans, managers see ALL team loans. No bank/cat/prod query restriction (fixes 'YES' vs 'YES BANK' mismatch)

## Pending / Backlog
- **P2:** Refactor `backend/server.py` into modular routers (~2400 lines)
