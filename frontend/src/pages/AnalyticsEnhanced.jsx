...
import { Building2, Users, TrendingUp, Calendar, Download, BarChart as BarChartIcon } from 'lucide-react';
...
const AnalyticsEnhanced = () => {
  ...
  const fetchAnalytics = async () => {
    try {
      const [trendsRes, bankRes, agentRes, monthRes, valuesRes] = await Promise.all([
  ...
  return (
    <div className=\"space-y-6 fade-in\" data-testid=\"analytics-enhanced-page\">
      ...
      {/* Bank Performance & Agent Distribution */}
